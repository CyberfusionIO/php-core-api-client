...
class DaemonCpuUsageMetricResource extends CoreApiModel implements CoreApiModelContract
{
    use Conditionable;

    public function __construct(string $daemonName, string $nodeHostname, int $timestamp, float $value)
    {
