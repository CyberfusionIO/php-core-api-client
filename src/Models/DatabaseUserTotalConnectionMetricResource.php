...
class DatabaseUserTotalConnectionMetricResource extends CoreApiModel implements CoreApiModelContract
{
    use Conditionable;

    public function __construct(string $databaseUserName, string $nodeHostname, int $timestamp, int $value)
    {
