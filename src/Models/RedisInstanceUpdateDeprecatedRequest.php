...
class RedisInstanceUpdateDeprecatedRequest extends CoreApiModel implements CoreApiModelContract
{
    ...
    {
        $this->setAttribute('maxDatabases', $maxDatabases);
        return $this;
    }
    ...
    {
        $this->setAttribute('evictionPolicy', $evictionPolicy);
        return $this;
    }
