...
class CustomConfigsSearchRequest extends CoreApiModel implements CoreApiModelContract
{
    use Conditionable;
    ...
    public function getServerSoftwareName(): CustomConfigServerSoftwareNameEnum|null
    {
    ...
    public static function fromArray(array $data): self
    {
        return (new self(
            ...
            ->when(Arr::has($data, 'server_software_name'), fn (self $model) => $model->setServerSoftwareName(Arr::get($data, 'server_software_name') !== null ? CustomConfigServerSoftwareNameEnum::tryFrom(Arr::get($data, 'server_software_name')) : null));
    }
}
