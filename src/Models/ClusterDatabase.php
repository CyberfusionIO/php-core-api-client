...
class ClusterDatabase extends CoreApiModel implements CoreApiModelContract
{
    ...
    public function getSite(): SiteDatabase
    {
        return $this->getAttribute('site');
    }

    public function setSite(?SiteDatabase $site = null): self
    {
        $this->setAttribute('site', $site);
        return $this;
    }

    public function getCustomer(): CustomerDatabase
    {
        return $this->getAttribute('customer');
    }

    public function setCustomer(?CustomerDatabase $customer = null): self
    {
    ...
    public static function fromArray(array $data): self
    {
        return (new self(
            ...
            site: SiteDatabase::fromArray(Arr::get($data, 'site')),
            customer: CustomerDatabase::fromArray(Arr::get($data, 'customer')),
