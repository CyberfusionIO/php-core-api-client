...
class ClusterElasticsearchPropertiesResource extends CoreApiModel implements CoreApiModelContract
{
    ...
    public function getIncludes(): ClusterElasticsearchPropertiesIncludes|null
    {
    ...
    public static function fromArray(array $data): self
    {
        return (new self(
            ...
            ->setIncludes(Arr::get($data, 'includes') !== null ? ClusterElasticsearchPropertiesIncludes::fromArray(Arr::get($data, 'includes')) : null);
    }
}
