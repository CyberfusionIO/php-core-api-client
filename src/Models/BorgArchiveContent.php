...
class BorgArchiveContent extends CoreApiModel implements CoreApiModelContract
{
    ...
    {
        $this->setAttribute('objectType', $objectType);
        return $this;
    }
    ...
    public function setSymbolicMode(?string $symbolicMode = null): self
    {
        Validator::create()
            ...
            ->regex('/^[rwx\+\-dlsStT]+$/')
            ->assert($symbolicMode);
        $this->setAttribute('symbolicMode', $symbolicMode);
        return $this;
    }
    ...
    {
        $this->setAttribute('linkTarget', $linkTarget);
        return $this;
    }
    ...
    {
        $this->setAttribute('modificationTime', $modificationTime);
        return $this;
    }
