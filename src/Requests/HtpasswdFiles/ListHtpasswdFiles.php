...
class ListHtpasswdFiles extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/htpasswd-files')
     ...
     * @returns Collection<HtpasswdFileResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, HtpasswdFileResource::class)->buildCollection();
    }
}
