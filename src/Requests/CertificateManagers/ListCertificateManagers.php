...
class ListCertificateManagers extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/certificate-managers')
     ...
     * @returns Collection<CertificateManagerResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, CertificateManagerResource::class)->buildCollection();
    }
}
