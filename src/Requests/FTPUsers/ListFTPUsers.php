...
class ListFTPUsers extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/ftp-users')
     ...
     * @returns Collection<FTPUserResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, FTPUserResource::class)->buildCollection();
    }
}
