...
class ListRootSSHKeys extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/root-ssh-keys')
     ...
     * @returns Collection<RootSSHKeyResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, RootSSHKeyResource::class)->buildCollection();
    }
}
