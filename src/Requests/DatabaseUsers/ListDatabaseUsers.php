...
class ListDatabaseUsers extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/database-users')
     ...
     * @returns Collection<DatabaseUserResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, DatabaseUserResource::class)->buildCollection();
    }
}
