 ...
 */
class DeprecatedUpdateMailAccounts extends Request implements CoreApiRequestContract, HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        private readonly MailAccountUpdateDeprecatedRequest $mailAccountUpdateDeprecatedRequest,
    ) {
    }
    ...
    {
        return $this->mailAccountUpdateDeprecatedRequest->toArray();
    }
