...
class ListMailAccounts extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/mail-accounts')
     ...
     * @returns Collection<MailAccountResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, MailAccountResource::class)->buildCollection();
    }
}
