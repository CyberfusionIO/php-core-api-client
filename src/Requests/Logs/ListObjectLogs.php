...
/**
 * Object logs are available for 45 days. Returned are object logs for **clusters** belonging to the **customer** of your **API user**.
 */
class ListObjectLogs extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/object-logs')
