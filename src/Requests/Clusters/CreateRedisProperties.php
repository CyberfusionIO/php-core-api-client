...
class CreateRedisProperties extends Request implements CoreApiRequestContract, HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        private readonly ClusterRedisPropertiesCreateRequest $clusterRedisPropertiesCreateRequest,
    ) {
    }

    public function resolveEndpoint(): string
    {
        return UrlBuilder::for('/api/v1/clusters/%d/properties/redis')
    ...
    {
        return $this->clusterRedisPropertiesCreateRequest->toArray();
    }
