...
class DeleteIpAddressForCluster extends Request implements CoreApiRequestContract
{
    ...
    {
        return sprintf('/api/v1/clusters/%d/ip-addresses/%s', $this->id, $this->ipAddress);
    }
