 ...
 */
class GetIPAddressesProductsForCustomers extends SoloRequest implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for($this->baseUrl . '/api/v1/customers/ip-addresses/products')->getEndpoint();
    }
