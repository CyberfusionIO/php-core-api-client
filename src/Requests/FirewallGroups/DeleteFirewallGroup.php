...
/**
 * The firewall group may no longer be used by database users and domain routers.
 */
class DeleteFirewallGroup extends Request implements CoreApiRequestContract
{
