...
/**
 * The following properties can never be updated to a different value: * `name`
 */
class DeprecatedUpdateFirewallGroup extends Request implements CoreApiRequestContract, HasBody
{
    use HasJsonBody;
    ...
    public function __construct(
        ...
        private readonly FirewallGroupUpdateDeprecatedRequest $firewallGroupUpdateDeprecatedRequest,
    ) {
    }
    ...
    {
        return $this->firewallGroupUpdateDeprecatedRequest->toArray();
    }
