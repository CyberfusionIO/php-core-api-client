...
class ListDatabaseUserGrantsForDatabaseUsers extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/database-user-grants/%d')
            ->addPathParameter($this->databaseUserId)
