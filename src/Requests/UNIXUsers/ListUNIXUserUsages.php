...
class ListUNIXUserUsages extends Request implements CoreApiRequestContract
{
     ...
     * @returns Collection<UNIXUserUsageResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, UNIXUserUsageResource::class)->buildCollection();
    }
}
