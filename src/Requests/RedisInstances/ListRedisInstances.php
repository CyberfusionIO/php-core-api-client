...
class ListRedisInstances extends Request implements CoreApiRequestContract
{
    ...
    {
        return UrlBuilder::for('/api/v1/redis-instances')
     ...
     * @returns Collection<RedisInstanceResource>|DetailMessage|Collection<ValidationError>
     */
    public function createDtoFromResponse(Response $response): Collection|DetailMessage
    {
        return DtoBuilder::for($response, RedisInstanceResource::class)->buildCollection();
    }
}
